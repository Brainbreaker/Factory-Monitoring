...
{
    public partial class ArtikelnummerSuchenLöschen : Window
    {
        ...
        public ArtikelnummerSuchenLöschen()
        {
            InitializeComponent();
        ...
        private void btnSuche_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                //sql befehl
                com.CommandText = "Delete Artikel where Artikelnummer='" + artikelnummer + "'";//<--------------------------------------------------SQL BEFEHL-MARKIERUNG
